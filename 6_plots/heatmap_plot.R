...
ht0 = Heatmap(patho.results,
              ...
              row_names_side    = "left", row_names_rot    = 0 , row_names_gp    = gpar(fontsize = 11.5, fontface = "bold"     ),
              column_names_side = "bottom" , column_names_rot = 90, column_names_gp = gpar(fontsize = 14, fontface = 2, lty = 1),
              rect_gp = gpar(col = "black", lty = 1, lwd = 0.5),
              show_heatmap_legend = T, heatmap_legend_param = list(title = "-log10(adjusted p)", title_gp = gpar(fontsize = 8), direction = "vertical", at = c(0,2,4), labels = c(0,2,4), legend_width = unit(7, "lines"), title_position ="leftcenter-rot")
)
...
ht2 = Heatmap(MAGMA.result, 
              ...
              column_names_side = "bottom" , column_names_rot = 90, column_names_gp = gpar(fontsize = 14, fontface = 2, lty = 1),
              rect_gp = gpar(col = "black", lty = 1, lwd = 0.5),
              show_heatmap_legend = F, heatmap_legend_param = list(title = "-log10(MAGMA pvalue)", title_gp = gpar(fontsize = 8), direction = "vertical", at = c(0,2,4), labels = c(0,2,4), legend_width = unit(7, "lines"), title_position ="leftcenter-rot")
)
...
ht3 = Heatmap(HMAGMA.result,
              ...
              column_names_side = "bottom" , column_names_rot = 90, column_names_gp = gpar(fontsize = 14, fontface = 2, lty = 1),
              rect_gp = gpar(col = "black", lty = 1, lwd = 0.5),
              show_heatmap_legend = F, heatmap_legend_param = list(title = "-log10(H-MAGMA pvalue)", title_gp = gpar(fontsize = 8), direction = "vertical", at = c(0,2,4), labels = c(0,2,4), legend_width = unit(7, "lines"), title_position ="leftcenter-rot")
)
...
ht4 = Heatmap(tissue,
              ...
              column_names_side = "bottom" , column_names_rot = 90, column_names_gp = gpar(fontsize = 14, fontface = 2, lty = 1),
              rect_gp = gpar(col = "black", lty = 1, lwd = 0.5),
              show_heatmap_legend = T, heatmap_legend_param = list(title = "tissue score", title_gp = gpar(fontsize = 8), direction = "vertical", at = c(0,1), labels = c(0,1), legend_width = unit(7, "lines"), title_position ="leftcenter-rot")
)

d = draw(ht0+ht2+ht3+ht1+ht4,
         column_title = NULL,column_title_gp = gpar(fontsize = 10, fontface = "bold"),
         column_title_side = "top" ,
         auto_adjust = T, merge_legends = F,
         ht_gap = unit(c(8), "mm"),
         padding = unit(c(5, 20, 4, 20), "mm"), #bottom, left, top, right paddings)
         heatmap_legend_side = NULL
) 

pdf("sda_quantile/Paper/heatmap.pdf",width = 12.5,height = 11)
print(d)
dev.off()
